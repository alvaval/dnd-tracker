...
export function transformSupabaseCharacter(char: any): Character {
    ...
    return new Character({
        ...
        level: char.level,
        xp: char.xp,
        race: char.races ? { index: char.race, name: raceName } : null,
        subrace: char.subraces ? { index: char.subrace, name: subraceName } : null,
        class: char.classes ? { index: char.class, name: className } : null,
        subclass: char.subclasses ? { index: char.subclass, name: subclassName } : null,
        background: char.backgrounds ? { index: char.background, name: backgroundName } : null,
        alignment: char.alignments ? { index: char.alignment, name: alignmentName, acronym: char.alignments.acronym } : null,
        abilityScores,
        skills,
